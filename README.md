...
| [agentic-os](projects/agentic-os/) | Private, self-hosted agentic OS for small companies — architecture spec v6.2 (Grok-shaped Assistants, Graphiti as derived graph). |

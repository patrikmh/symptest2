...
export const appContract = {
  ...
  lots: {
    ...
    fyrar: {
      list: oc.output(z.array(FyrSchema)),
      get: oc.input(z.object({ fyrId: Id })).output(FyrSchema),
      create: oc.input(CreateFyrInput).output(FyrSchema),
      update: oc.input(UpdateFyrInput).output(FyrSchema),
      pause: oc.input(z.object({ fyrId: Id })).output(FyrSchema),
